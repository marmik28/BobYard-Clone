  ...
  <section className="py-16 border-b border-border" data-testid="section-brand-carousel">
    <div className="container mx-auto px-4 lg:px-6">
      ...
      <div className="overflow-hidden">
        <div
          className="flex animate-scroll-left hover:pause space-x-12"
          data-testid="carousel-track"
        >
          {Array(2) // duplicate once for seamless loop
            .fill(null)
            .flatMap(() => brands)
            .map((brand, index) => (
              <img
                ...
                src={brand}
                alt={`Brand ${index + 1}`}
                className="h-8 opacity-60 hover:opacity-100 transition-opacity filter invert"
